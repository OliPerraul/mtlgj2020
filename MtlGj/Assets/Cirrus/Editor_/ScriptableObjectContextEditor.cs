...
namespace Cirrus.Editor
{
    ...
    public class ScriptableObjectContextEditor
    {
        ...
        [MenuItem("Assets/Show SubAssets", false, 1)]
        static void SetSubAssetHideFlags()
        {
            //UnityEngine.Object[] os = UnityEditor.AssetDatabase.LoadAllAssetsAtPath(UnityEditor.AssetDatabase.GetAssetPath(target));
            foreach (Object o in Selection.objects)
            {

                o.hideFlags = o.hideFlags & ~HideFlags.HideInHierarchy;
                o.hideFlags = o.hideFlags & ~HideFlags.HideInInspector;
